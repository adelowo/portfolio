...
title : A guide to understanding HTTP Request handling and processing in Golang
...
import (
	...
	m "github.com/username/app/middleware"
...
> Note that while this is slightly difference in syntax from `func PostLogin(w http.ResponseWriter, r *http.Request)`. It actually does the same thing. This is just to allow stuffs like [dependency injection into your handlers][reblog]
...
> In the previous example with `pressly/chi`, i used middleware. I hope to write about that sometime in the nearest future - just remember that they are still Handlers.
...
[reblog]: https://github.com/adelowo/reblog