...
layout: post
tags : ["vim"]
title: "On switching to Vim"

---

As a self taught developer, I am always lookng out for ways to improve my software dev kit and knowledge.
...
I heard good things about VS code - a friend uses this and it seemed a little popular in the Go community.
...
The ___love___ part is that it was the editor I used to write the code that ended up being my [first open source PR][first_pr]
and my first [open source library/package][cfar] after about 10 months of learning to code.
The ___hate___ part is the same reason with [I hate any other Electron app][flash_for_desktop].
...
Although, muscle memory helps me a lot and I don't even have to ___remember which is which___, I just place my hands on the keyboard and navigate through.
...
Or was it `16l` only to learn somewhere else you could use `lw`.
...
was never still confident, I knew enough to do stuffs, so I kept Sublime text around. 2 months after, Vim (Neovim actually) is only editor installed
...
[go_tags]: /tags/#go
[elementary]: https://elementaryos.org
[cfar]: https://github.com/adelowo/cfar
[first_pr]: https://github.com/Gargron/fileupload
[flash_for_desktop]: https://medium.com
