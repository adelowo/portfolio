...
![only gods are allowed to make use of our app](/img/log/long_live_the_gods.png)
...
![Your startup is broken](/img/log/broken-startup.png)
...
![We fixed our startup's bug](/img/log/parameterized_routing.png)

And for the 404 response if a god couldn't be found

![god does not exist](/img/log/parameterized_routing_error.png)
